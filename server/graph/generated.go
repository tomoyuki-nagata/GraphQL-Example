...
func (ec *executionContext) marshalNCategory2graphqlᚑexampleᚋgraphᚋmodelᚐCategory(ctx context.Context, sel ast.SelectionSet, v model.Category) graphql.Marshaler {
